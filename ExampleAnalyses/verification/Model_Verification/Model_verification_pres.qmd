...
#| label: fig-abovemass
#| fig-cap: "Total Mass Response with different Effects "
ggplot(alltrtw1%>% filter(HT == "Fixed"),aes(x=Time,y=Mean))+annotate("rect", xmin = 5*30, xmax = 6*30, ymin = -Inf, ymax = Inf,alpha = .1,fill = "blue")+geom_line(aes(x=Time,y=Mean,col=factor(HCx)))+geom_point(aes(x=Time,y=Mean,col=factor(HCx)))+geom_ribbon(aes(ymin=`5th Per.`,ymax=`95th Per.`,fill=factor(HCx)),alpha=0.1)+facet_wrap(EP~.)+ylab("Above Mass")+xlim(c(120,200))+ggtitle("HCx==0.05 vs. 0.95")
```
## Below Mass
...
ggplot(alltrtw1%>% filter(HT == "Fixed"),aes(x=Time,y=Mean))+annotate("rect", xmin = 5*30, xmax = 6*30, ymin = -Inf, ymax = Inf,alpha = .1,fill = "blue")+geom_line(aes(x=Time,y=Mean,col=factor(HCx)))+geom_point(aes(x=Time,y=Mean,col=factor(HCx)))+geom_ribbon(aes(ymin=`5th Per.`,ymax=`95th Per.`,fill=factor(HCx)),alpha=0.1)+facet_wrap(EP~.)+ylab("Below Mass")+xlim(c(120,200))+ggtitle("HCx==0.05 vs. 0.95")
```
...
ggplot(alltrtw1%>% filter(HT == "Fixed"),aes(x=Time,y=Mean))+annotate("rect", xmin = 5*30, xmax = 6*30, ymin = -Inf, ymax = Inf,alpha = .1,fill = "blue")+geom_line(aes(x=Time,y=Mean,col=factor(HCx)))+geom_point(aes(x=Time,y=Mean,col=factor(HCx)))+geom_ribbon(aes(ymin=`5th Per.`,ymax=`95th Per.`,fill=factor(HCx)),alpha=0.1)+facet_wrap(EP~.)+ylab("Shannon")+xlim(c(120,200))+ggtitle("HCx==0.05 vs. 0.95")
```
...
ggplot(alltrtw1%>% filter(HT == "Fixed"),aes(x=Time,y=Mean))+annotate("rect", xmin = 5*30, xmax = 6*30, ymin = -Inf, ymax = Inf,alpha = .1,fill = "blue")+geom_line(aes(x=Time,y=Mean,col=factor(HCx)))+geom_point(aes(x=Time,y=Mean,col=factor(HCx)))+geom_ribbon(aes(ymin=`5th Per.`,ymax=`95th Per.`,fill=factor(HCx)),alpha=0.1)+facet_wrap(EP~.)+ylab("NPFT")+xlim(c(120,200))+ggtitle("HCx==0.05 vs. 0.95")
```