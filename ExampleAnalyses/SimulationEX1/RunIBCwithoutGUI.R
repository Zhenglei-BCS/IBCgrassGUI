...
load("ExampleAnalyses/SimulationEX1/HerbicideSettings/Herbicides/SimulationSettings.Rdata") # just as an example for this script
#####
...
save(timeinfo,"~/Projects/Research/IBCgrassGUI/ExampleAnalyses/SimulationEX1/timeinfor.rda")